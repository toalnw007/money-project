@layer components {
    ...
    &.nav-tabs {
      ...
      .nav-item {
        ...
        .nav-link {
          ...
          &.active {
            @apply bg-white border-slate-200 border-b-transparent font-medium ;
          }
        }
      }
    }
    ...
    &.nav-boxed-tabs {
      .nav-item {
        .nav-link {
          ...
          @apply rounded-md;
          &.active {
            @apply bg-slate-100 text-primary font-medium;
          }
        }
      }
    }
  ...
  .nav-link {
    @apply block appearance-none px-5 py-2.5 border border-transparent text-slate-700 ;
    &.active {
