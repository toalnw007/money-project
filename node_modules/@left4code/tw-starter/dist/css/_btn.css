@layer components {
  ...
  .btn-secondary {
    @apply bg-secondary/70 border-secondary/70 text-slate-500 ;
    &:hover:not(:disabled) {
  ...
  .btn-dark {
    @apply bg-dark border-dark text-white dark:bg-darkmode-800 dark:border-transparent ;
    &:hover:not(:disabled) {
  ...
  .btn-outline-pending {
    @apply border-pending text-pending ;
    &:hover:not(:disabled) {
      @apply bg-pending/10;
    }
  }
  ...
  /* Button Soft Colors */
  .btn-primary-soft {
    @apply bg-primary border-primary bg-opacity-20 border-opacity-5 text-primary dark:border-opacity-100 dark:bg-opacity-20 ;
    &:hover:not(:disabled) {
      @apply bg-opacity-10 border-opacity-10 ;
    }
  }
  .btn-secondary-soft {
    @apply bg-slate-300 bg-opacity-20 text-slate-500   ;
    &:hover:not(:disabled) {
      @apply bg-opacity-10 ;
    }
  }
  .btn-success-soft {
    @apply bg-success border-success bg-opacity-20 border-opacity-5 text-success  ;
    &:hover:not(:disabled) {
      @apply bg-opacity-10 border-opacity-10;
    }
  }
  .btn-warning-soft {
    @apply bg-warning border-warning bg-opacity-20 border-opacity-5 text-warning  ;
    &:hover:not(:disabled) {
      @apply bg-opacity-10 border-opacity-10;
    }
  }
  .btn-pending-soft {
    @apply bg-pending border-pending bg-opacity-20 border-opacity-5 text-pending  ;
    &:hover:not(:disabled) {
      @apply bg-opacity-10 border-opacity-10;
    }
  }
  .btn-danger-soft {
    @apply bg-danger border-danger bg-opacity-20 border-opacity-5 text-danger dark:border-danger ;
    &:hover:not(:disabled) {
      @apply bg-opacity-10 border-opacity-10;
    }
  }
  .btn-dark-soft {
    @apply bg-dark border-dark bg-opacity-20 border-opacity-5 text-dark  ;
    &:hover:not(:disabled) {
      @apply bg-opacity-10 border-opacity-10  ;
    }
  }
